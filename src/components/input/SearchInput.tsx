...
function SearchInput(props: Props) {
  return (
    <div
      className={cn(
        "bg-background rounded-full flex items-center space-x-2 group  w-full max-w-[40rem] p-1 relative overflow-hidden",
        props.className,
    ...
    >
      ...
      <Button
        type="button"
        className={cn(
          "rounded-full bg-primary text-white p-3 px-6 cursor-pointer z-50",
